<?php
/**
 * Unit tests covering WP_Icons_Registry::sanitize_icon_content functionality.
 *
 * @package Gutenberg
 */
class WP_Icons_Registry_Test extends WP_UnitTestCase {

	/**
	 * Invokes the private sanitize_icon_content method on the registry instance.
	 *
	...
	private function sanitize_icon_content( $icon_content ) {
		...
		$method   = new ReflectionMethod( WP_Icons_Registry::class, 'sanitize_icon_content' );
	 ...
	 * @covers WP_Icons_Registry::sanitize_icon_content
	 *
